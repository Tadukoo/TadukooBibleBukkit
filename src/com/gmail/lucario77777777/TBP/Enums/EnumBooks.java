...
public enum EnumBooks {
	GENESIS("Genesis", "Gen", "about Creation up through the time the Israelites go to Egypt", "Moses", 1, 
			50, true),
	EXODUS("Exodus", "Exo", "about the time from the Exodus of the Israelites from Egypt up to the laws " +
			"given to the Israelites by God", "Moses", 2, 40, true),
	LEVITICUS("Leviticus", "Lev", "about the various laws that were given to the Israelites by God", 
			"Moses", 3, 27, true),
	NUMBERS("Numbers", "Num", "about the various laws that were given to the Israelites by God", "Moses",
			4, 36, true),
	DEUTERONOMY("Deuteronomy", "Deu", "about the laws given to the Israelites by God through Moses",
			"Moses", 5, 34, true),
	...
	PSALMS("Psalms", "Psalm", "a book containing poetry", "Many people", 19, 150, true),
	...
	JONAH("Jonah", "Jon",  "", "Jonah", 32, 4, false),
	MICAH("Micah",  "Mic", "", "Micah", 33, 7, false),
	NAHUM("Nahum", "Nah",  "", "Nahum", 34, 3, false),
	...
	MATTHEW("Matthew", "Mat", "about Jesus' life", "Matthew", 40, 28, true),
	MARK("Mark", "about Jesus' life", "John Mark", 41, 16, true),
	LUKE("Luke", "about Jesus' life", "Luke", 42, 24, true),
	JOHN("John", "about Jesus' life", "John", 43, 21, true),
	...
	JOHN1("1John", "about how to discern true teachers", "John", 62, 5, true),
	JOHN2("2John", "about focusing on Jesus Christ", "John", 63, 1, true),
	JOHN3("3John", "about loving God and other people", "John", 64, 1, true),
	...
	private EnumBooks(String book, String desc, String author, int num, int chp, boolean KJV){
		this.book = book;
		this.desc = desc;
		this.author = author;
		this.num = num;
	...
	private EnumBooks(String book, String alias, String desc, String author, int num, int chp, boolean KJV){
		this.book = book;
		this.alias = alias;
		this.desc = desc;
		this.author = author;
