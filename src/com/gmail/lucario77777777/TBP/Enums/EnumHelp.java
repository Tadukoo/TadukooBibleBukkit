...
public enum EnumHelp {
	...
	SEND2("send2", 10, "sendverse2", "versesend2", "giveverse2", "versegive2", "sendv2", "vsend2", "givev2",
			"vgive2"),
	PREVIOUS("previous1", 11, "previous", "pre", "prev", "back", "before", "b4", "pre1", "prev1", "back1",
			"before1"),
	PREVIOUS1("previous1", 11, "b41"),
	PREVIOUS2("previous2", 12, "pre2", "prev2", "back2", "before2", "b42"),
	NEXT("next1", 13, "next", "forward", "for", "after", "aft", "nextverse", "versenext", "nextv", "vnext",
			"forward1"),
	NEXT1("next1", 13, "for1", "after1", "aft1", "nextverse1", "versenext1", "nextv1", "vnext1"),
	NEXT2("next2", 14, "forward2", "for2", "after2", "aft2", "nextverse2", "versenext2", "nextv2", "vnext2"),
	LAST("last1", 15, "last", "saved", "save", "load", "lastverse", "verselast", "lastv", "vlast", 
			"versesaved", "savedverse"),
	LAST1("last1", 15, "vsaved", "savedv", "vsave", "versesave", "loadverse", "verseload", "vload", "loadv",
			"saved1", "save1"),
	LAST1A("last1", 15, "load1", "lastverse1", "verselast1", "lastv1", "vlast1", "versesaved1", "savedverse1",
			"vsaved1", "savedv1", "vsave1"),
	LAST1B("last1", 15, "versesave1", "loadverse1", "verseload1", "vload1", "loadv1"),
	RANDOM("random1", 16, "random", "rand", "randomverse", "randomv", "verserandom", "vrandom", "randverse",
			"randv", "verserand", "vrand"),
	RANDOM1("random1", 16, "rand1", "randomverse1", "randomv1", "verserandom1", "vrandom1", "randverse1",
			"randv1", "verserand1", "vrand1"),
	RANDOM2("random2", 17, "rand2", "randomverse2", "randomv2", "verserandom2", "vrandom2", "randverse2",
			"randv2", "verserand2", "vrand2"),
	GETBOOK("getbook1", 18, "getbook", "book", "bookget", "getbible", "bibleget", "book1", "bookget1",
			"getbible1", "bibleget1"),
	GETBOOK2("getbook2", 19, "book2", "bookget2", "getbible2", "bibleget2"),
	GETBOOK3("getbook3", 20, "book3", "bookget3", "getbible3", "bibleget3"),
	SENDBOOK("sendbook1", 21, "sendbook", "booksend", "sendbible", "biblesend", "givebook", "bookgive",
			"biblegive", "givebible", "booksend1", "sendbible1"),
	SENDBOOK1("sendbook1", 21, "biblesend1", "givebook1", "bookgive1", "biblegive1", "givebible1"),
	SENDBOOK2("sendbook2", 22, "booksend2", "sendbible2", "biblesend2", "givebook2", "bookgive2", "biblegive2",
			"givebible2"),
	INFO("info1", 23, "info", "about", "abt", "information", "about1", "abt1", "information1"),
	INFO2("info2", 24, "about2", "abt2", "information2"),
	PLUGIN("plugin1", 25, "plugin", "TB", "TadukooBible", "TadukooBibleinfo", "plugininfo", "TB1", 
			"TadukooBible1", "TadukooBibleinfo1", "plugininfo1"),
	BOOKS("books1", 26, "books", "bookslist", "listbooks", "booklist", "bookslist1", "listbooks1",
			"booklist1"),
	TRANSLATION("translation1", 27, "translation", "translations", "translist", "translationslist",
			"listtrans", "tran", "trans", "translationinfo", "translationsinfo", "transinfo"),
	TRANSLATION1("translation1", 27, "traninfo", "translations1", "translist1", "translationslist1", 
			"listtrans1", "tran1", "trans1", "translationinfo1", "translationsinfo1", "transinfo1"),
	TRANSLATION2("translation1", 27, "traninfo1"),
	CONFIG("config1", 28, "config", "configuration", "settings", "set", "options", "configuration1",
			"settings1", "set1", "options1"),
	ANNOUNCE("announce1", 29, "announce", "ann", "broadcast", "broad", "shout", "yell", "ann1", 
			"broadcast1", "broad1", "shout1"),
	ANNOUNCE1("announce1", 29, "yell1");
