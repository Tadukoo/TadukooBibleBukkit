...
public class Lists {
	...
	public static void help(String i, CommandSender sender, Main plugin){
		if(i.equalsIgnoreCase("1") || i.equalsIgnoreCase("toc") || i.equalsIgnoreCase("tableofcontents")){
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 1/16 Table of Contents (1/3).");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 2/16 Table of Contents (2/3).");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 3/16 Table of Contents (3/3)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 4/16 /bible (1/2)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 5/16 /bible Cont. (2/2)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 6/16 /bible config (1/1)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 7/16 /bible info (1/1)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 8/16 /bible books (1/1)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 9/16 /bible translations (1/1)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 10/16 /bible getbook (1/3)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 11/16 /bible getbook Cont. (2/3)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 12/16 /bible getbook Cont. (3/3)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 13/16 /bible givebook (1/2)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 14/16 /bible givebook Cont. (2/2)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 15/16 /bible random (1/2)");
			...
			sender.sendMessage(ChatColor.GREEN + "TadukooBible Help Page 16/16 /bible random Cont. (2/2)");
