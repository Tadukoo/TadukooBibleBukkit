...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh1;
...
public class KJVExodusCh1 extends KJVExodus {
	public KJVExodusCh1(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh1.getV1();
