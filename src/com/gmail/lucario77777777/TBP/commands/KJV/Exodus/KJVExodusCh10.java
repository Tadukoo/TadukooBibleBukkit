...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh10;
...
public class KJVExodusCh10 extends KJVExodus {
	public KJVExodusCh10(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh10.getV1();
