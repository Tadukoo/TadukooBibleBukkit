...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh11;
...
public class KJVExodusCh11 extends KJVExodus {
	public KJVExodusCh11(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh11.getV1();
