...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh13;
...
public class KJVExodusCh13 extends KJVExodus {
	public KJVExodusCh13(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh13.getV1();
