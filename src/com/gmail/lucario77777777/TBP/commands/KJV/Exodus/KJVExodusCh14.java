...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh14;
...
public class KJVExodusCh14 extends KJVExodus {
	public KJVExodusCh14(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh14.getV1();
