...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh20;
...
public class KJVExodusCh20 extends KJVExodus {
	public KJVExodusCh20(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh20.getV1();
