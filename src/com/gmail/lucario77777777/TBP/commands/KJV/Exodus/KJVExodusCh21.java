...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh21;
...
public class KJVExodusCh21 extends KJVExodus {
	public KJVExodusCh21(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh21.getV1();
