...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh22;
...
public class KJVExodusCh22 extends KJVExodus {
	public KJVExodusCh22(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh22.getV1();
