...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh23;
...
public class KJVExodusCh23 extends KJVExodus {
	public KJVExodusCh23(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh23.getV1();
