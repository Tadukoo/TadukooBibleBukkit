...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh24;
...
public class KJVExodusCh24 extends KJVExodus {
	public KJVExodusCh24(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh24.getV1();
