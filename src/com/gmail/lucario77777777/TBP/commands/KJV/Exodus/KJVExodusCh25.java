...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh25;
...
public class KJVExodusCh25 extends KJVExodus {
	public KJVExodusCh25(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh25.getV1();
