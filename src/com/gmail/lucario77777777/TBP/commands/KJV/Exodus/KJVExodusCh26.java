...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh26;
...
public class KJVExodusCh26 extends KJVExodus {
	public KJVExodusCh26(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh26.getV1();
