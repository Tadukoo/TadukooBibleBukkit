...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh27;
...
public class KJVExodusCh27 extends KJVExodus {
	public KJVExodusCh27(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh27.getV1();
