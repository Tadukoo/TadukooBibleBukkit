...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh28;
...
public class KJVExodusCh28 extends KJVExodus {
	public KJVExodusCh28(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh28.getV1();
