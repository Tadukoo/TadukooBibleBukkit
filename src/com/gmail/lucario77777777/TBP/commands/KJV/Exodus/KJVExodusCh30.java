...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh30;
...
public class KJVExodusCh30 extends KJVExodus {
	public KJVExodusCh30(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh30.getV1();
