...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh31;
...
public class KJVExodusCh31 extends KJVExodus {
	public KJVExodusCh31(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh31.getV1();
