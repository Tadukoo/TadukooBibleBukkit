...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh32;
...
public class KJVExodusCh32 extends KJVExodus {
	public KJVExodusCh32(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh32.getV1();
