...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh34;
...
public class KJVExodusCh34 extends KJVExodus {
	public KJVExodusCh34(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh34.getV1();
