...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh35;
...
public class KJVExodusCh35 extends KJVExodus {
	public KJVExodusCh35(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh35.getV1();
