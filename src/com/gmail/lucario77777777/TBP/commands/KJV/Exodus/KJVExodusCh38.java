...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh38;
...
public class KJVExodusCh38 extends KJVExodus {
	public KJVExodusCh38(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh38.getV1();
