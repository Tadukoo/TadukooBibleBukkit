...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh40;
...
public class KJVExodusCh40 extends KJVExodus {
	public KJVExodusCh40(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh40.getV1();
