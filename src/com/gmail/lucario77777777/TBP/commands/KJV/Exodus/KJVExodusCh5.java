...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh5;
...
public class KJVExodusCh5 extends KJVExodus {
	public KJVExodusCh5(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh5.getV1();
