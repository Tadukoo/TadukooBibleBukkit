...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh6;
...
public class KJVExodusCh6 extends KJVExodus {
	public KJVExodusCh6(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh6.getV1();
