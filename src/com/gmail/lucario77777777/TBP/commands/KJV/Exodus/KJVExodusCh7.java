...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh7;
...
public class KJVExodusCh7 extends KJVExodus {
	public KJVExodusCh7(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh7.getV1();
