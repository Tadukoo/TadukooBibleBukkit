...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh8;
...
public class KJVExodusCh8 extends KJVExodus {
	public KJVExodusCh8(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh8.getV1();
