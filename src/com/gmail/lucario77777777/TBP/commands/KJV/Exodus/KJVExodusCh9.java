...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Exodus.KJVBibleExodusCh9;
...
public class KJVExodusCh9 extends KJVExodus {
	public KJVExodusCh9(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleExodusCh9.getV1();
