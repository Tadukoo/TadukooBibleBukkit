...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh10;
...
public class KJVGenesisCh10 extends KJVGenesis {
	public KJVGenesisCh10(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh10.getV1();
