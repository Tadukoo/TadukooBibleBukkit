...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh11;
...
public class KJVGenesisCh11 extends KJVGenesis {
	public KJVGenesisCh11(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh11.getV1();
