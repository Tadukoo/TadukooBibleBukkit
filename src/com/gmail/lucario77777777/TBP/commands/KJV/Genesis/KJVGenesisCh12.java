...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh12;
...
public class KJVGenesisCh12 extends KJVGenesis {
	public KJVGenesisCh12(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh12.getV1();
