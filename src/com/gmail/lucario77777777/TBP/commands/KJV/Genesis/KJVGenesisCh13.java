...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh13;
...
public class KJVGenesisCh13 extends KJVGenesis {
	public KJVGenesisCh13(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh13.getV1();
