...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh14;
...
public class KJVGenesisCh14 extends KJVGenesis {
	public KJVGenesisCh14(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh14.getV1();
