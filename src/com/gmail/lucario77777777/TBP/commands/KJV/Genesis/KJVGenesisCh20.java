...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh20;
...
public class KJVGenesisCh20 extends KJVGenesis {
	public KJVGenesisCh20(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh20.getV1();
