...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh21;
...
public class KJVGenesisCh21 extends KJVGenesis {
	public KJVGenesisCh21(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh21.getV1();
