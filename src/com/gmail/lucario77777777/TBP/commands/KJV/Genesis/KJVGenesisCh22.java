...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh22;
...
public class KJVGenesisCh22 extends KJVGenesis {
	public KJVGenesisCh22(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh22.getV1();
