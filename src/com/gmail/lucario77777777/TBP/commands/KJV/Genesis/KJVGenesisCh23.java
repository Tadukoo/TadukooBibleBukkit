...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh23;
...
public class KJVGenesisCh23 extends KJVGenesis {
	public KJVGenesisCh23(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh23.getV1();
