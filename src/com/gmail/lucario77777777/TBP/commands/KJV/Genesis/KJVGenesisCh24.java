...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh24;
...
public class KJVGenesisCh24 extends KJVGenesis {
	public KJVGenesisCh24(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh24.getV1();
