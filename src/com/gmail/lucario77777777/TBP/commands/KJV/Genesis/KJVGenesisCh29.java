...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh29;
...
public class KJVGenesisCh29 extends KJVGenesis {
	public KJVGenesisCh29(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh29.getV1();
