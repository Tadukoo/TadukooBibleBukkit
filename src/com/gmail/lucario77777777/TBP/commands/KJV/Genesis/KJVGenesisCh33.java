...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh33;
...
public class KJVGenesisCh33 extends KJVGenesis {
	public KJVGenesisCh33(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh33.getV1();
