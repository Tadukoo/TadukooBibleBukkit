...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh34;
...
public class KJVGenesisCh34 extends KJVGenesis {
	public KJVGenesisCh34(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh34.getV1();
