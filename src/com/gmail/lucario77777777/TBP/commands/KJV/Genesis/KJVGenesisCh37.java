...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh37;
...
public class KJVGenesisCh37 extends KJVGenesis {
	public KJVGenesisCh37(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh37.getV1();
