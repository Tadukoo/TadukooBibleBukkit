...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh38;
...
public class KJVGenesisCh38 extends KJVGenesis {
	public KJVGenesisCh38(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh38.getV1();
