...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh39;
...
public class KJVGenesisCh39 extends KJVGenesis {
	public KJVGenesisCh39(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh39.getV1();
