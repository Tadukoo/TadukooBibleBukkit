...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh4;
...
public class KJVGenesisCh4 extends KJVGenesis {
	public KJVGenesisCh4(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh4.getV1();
