...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh40;
...
public class KJVGenesisCh40 extends KJVGenesis {
	public KJVGenesisCh40(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh40.getV1();
