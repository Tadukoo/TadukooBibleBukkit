...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh41;
...
public class KJVGenesisCh41 extends KJVGenesis {
	public KJVGenesisCh41(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh41.getV1();
