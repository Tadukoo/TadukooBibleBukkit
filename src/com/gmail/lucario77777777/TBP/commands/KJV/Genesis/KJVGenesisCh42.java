...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh42;
...
public class KJVGenesisCh42 extends KJVGenesis {
	public KJVGenesisCh42(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh42.getV1();
