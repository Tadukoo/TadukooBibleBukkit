...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh43;
...
public class KJVGenesisCh43 extends KJVGenesis {
	public KJVGenesisCh43(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh43.getV1();
