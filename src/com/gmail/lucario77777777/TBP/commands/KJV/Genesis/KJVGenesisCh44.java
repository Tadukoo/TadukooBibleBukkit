...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh44;
...
public class KJVGenesisCh44 extends KJVGenesis {
	public KJVGenesisCh44(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh44.getV1();
