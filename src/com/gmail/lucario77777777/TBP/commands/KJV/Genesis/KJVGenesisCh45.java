...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh45;
...
public class KJVGenesisCh45 extends KJVGenesis {
	public KJVGenesisCh45(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh45.getV1();
