...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh46;
...
public class KJVGenesisCh46 extends KJVGenesis {
	public KJVGenesisCh46(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh46.getV1();
