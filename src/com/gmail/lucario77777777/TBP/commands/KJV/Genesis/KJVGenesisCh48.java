...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh48;
...
public class KJVGenesisCh48 extends KJVGenesis {
	public KJVGenesisCh48(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh48.getV1();
