...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh5;
...
public class KJVGenesisCh5 extends KJVGenesis {
	public KJVGenesisCh5(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh5.getV1();
