...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh50;
...
public class KJVGenesisCh50 extends KJVGenesis {
	public KJVGenesisCh50(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh50.getV1();
