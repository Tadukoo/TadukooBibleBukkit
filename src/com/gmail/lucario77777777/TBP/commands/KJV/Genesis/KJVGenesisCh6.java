...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh6;
...
public class KJVGenesisCh6 extends KJVGenesis {
	public KJVGenesisCh6(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh6.getV1();
