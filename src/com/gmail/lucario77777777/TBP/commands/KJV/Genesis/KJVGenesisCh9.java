...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Genesis.KJVBibleGenesisCh9;
...
public class KJVGenesisCh9 extends KJVGenesis {
	public KJVGenesisCh9(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleGenesisCh9.getV1();
