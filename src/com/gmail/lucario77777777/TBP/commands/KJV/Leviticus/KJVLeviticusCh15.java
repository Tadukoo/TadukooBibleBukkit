...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh15;
...
public class KJVLeviticusCh15 extends KJVLeviticus {
	public KJVLeviticusCh15(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh15.getV1();
