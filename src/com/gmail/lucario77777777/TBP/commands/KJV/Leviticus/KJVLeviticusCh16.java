...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh16;
...
public class KJVLeviticusCh16 extends KJVLeviticus {
	public KJVLeviticusCh16(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh16.getV1();
