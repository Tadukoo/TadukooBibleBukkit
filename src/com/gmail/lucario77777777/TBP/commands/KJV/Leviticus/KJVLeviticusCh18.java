...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh18;
...
public class KJVLeviticusCh18 extends KJVLeviticus {
	public KJVLeviticusCh18(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh18.getV1();
