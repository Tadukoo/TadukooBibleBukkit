...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh2;
...
public class KJVLeviticusCh2 extends KJVLeviticus {
	public KJVLeviticusCh2(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh2.getV1();
