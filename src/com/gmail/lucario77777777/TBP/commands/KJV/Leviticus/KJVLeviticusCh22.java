...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh22;
...
public class KJVLeviticusCh22 extends KJVLeviticus {
	public KJVLeviticusCh22(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh22.getV1();
