...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh24;
...
public class KJVLeviticusCh24 extends KJVLeviticus {
	public KJVLeviticusCh24(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh24.getV1();
