...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh3;
...
public class KJVLeviticusCh3 extends KJVLeviticus {
	public KJVLeviticusCh3(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh3.getV1();
