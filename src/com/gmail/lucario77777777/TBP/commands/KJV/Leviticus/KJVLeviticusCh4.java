...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh4;
...
public class KJVLeviticusCh4 extends KJVLeviticus {
	public KJVLeviticusCh4(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh4.getV1();
