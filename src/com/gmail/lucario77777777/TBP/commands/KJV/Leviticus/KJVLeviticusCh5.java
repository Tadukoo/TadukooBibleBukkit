...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh5;
...
public class KJVLeviticusCh5 extends KJVLeviticus {
	public KJVLeviticusCh5(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh5.getV1();
