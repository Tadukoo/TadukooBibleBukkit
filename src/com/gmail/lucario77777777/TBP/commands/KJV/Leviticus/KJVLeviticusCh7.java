...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh7;
...
public class KJVLeviticusCh7 extends KJVLeviticus {
	public KJVLeviticusCh7(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh7.getV1();
