...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh8;
...
public class KJVLeviticusCh8 extends KJVLeviticus {
	public KJVLeviticusCh8(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh8.getV1();
