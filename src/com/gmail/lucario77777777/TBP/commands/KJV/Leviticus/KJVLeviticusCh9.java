...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Leviticus.KJVBibleLeviticusCh9;
...
public class KJVLeviticusCh9 extends KJVLeviticus {
	public KJVLeviticusCh9(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleLeviticusCh9.getV1();
