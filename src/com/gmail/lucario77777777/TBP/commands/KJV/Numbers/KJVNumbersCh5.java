...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Numbers.KJVBibleNumbersCh5;
...
public class KJVNumbersCh5 extends KJVNumbers {
	public KJVNumbersCh5(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleNumbersCh5.getV1();
