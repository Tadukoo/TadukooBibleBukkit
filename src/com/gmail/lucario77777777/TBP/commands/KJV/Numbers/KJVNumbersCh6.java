...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Numbers.KJVBibleNumbersCh6;
...
public class KJVNumbersCh6 extends KJVNumbers {
	public KJVNumbersCh6(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleNumbersCh6.getV1();
