...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Numbers.KJVBibleNumbersCh8;
...
public class KJVNumbersCh8 extends KJVNumbers {
	public KJVNumbersCh8(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleNumbersCh8.getV1();
