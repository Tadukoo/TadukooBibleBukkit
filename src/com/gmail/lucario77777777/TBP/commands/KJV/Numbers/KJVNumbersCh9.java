...
import com.gmail.lucario77777777.TBP.commands.KJV.bible.Numbers.KJVBibleNumbersCh9;
...
public class KJVNumbersCh9 extends KJVNumbers {
	public KJVNumbersCh9(Main plugin) {
		super(plugin);
	}
	...
	{
		if(args.length <= 3){
			String v1 = KJVBibleNumbersCh9.getV1();
