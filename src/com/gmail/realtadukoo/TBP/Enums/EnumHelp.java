...
public enum EnumHelp {
	...
	BOOKS(28, "books", "books.description", "books.usage", "books.aliases", "nextPageSpec", 1, false, "books",
			"bookslist", "listbooks", "booklist", "bookslist1"),
	BOOKS1(28, "books", "books.description", "books.usage", "books.aliases", "nextPageSpec", 1, false,
			"listbooks1", "booklist1", "books1"),
	BOOKS2(29, "books", "books.permission", "books.note", "", "", 2, true, "bookslist2", "listbooks2",
			"booklist2", "books2"),
	TRANSLATION(30, "tran", "tran.description", "tran.usage", "tran.aliases", "tran.permission", 1, true,
			"translation", "translations", "translist", "translationslist", "listtrans"),
	TRANSLATION1(30, "tran", "tran.description", "tran.usage", "tran.aliases", "tran.permission", 1, true,
			"tran", "trans", "translationinfo", "translationsinfo", "transinfo"),
	TRANSLATION1A(30, "tran", "tran.description", "tran.usage", "tran.aliases", "tran.permission", 1, true,
			"traninfo", "translations1", "translist1", "translationslist1", "listtrans1"),
	TRANSLATION1B(30, "tran", "tran.description", "tran.usage", "tran.aliases", "tran.permission", 1, true,
			"tran1", "trans1", "translationinfo1", "translationsinfo1", "transinfo1"),
	TRANSLATION1C(30, "tran", "tran.description", "tran.usage", "tran.aliases", "tran.permission", 1, true,
			"traninfo1", "translation1"),
	CONFIG(30, "config", "config.description", "config.usage", "config.aliases", "nextPageSpec", 1, false,
			"config", "configuration", "settings", "set", "options"),
	CONFIG1(30, "config", "config.description", "config.usage", "config.aliases", "nextPageSpec", 1, false,
			"configuration1", "settings1", "set1", "options1", "config1"),
	CONFIG2(31, "config", "config.permission", "config.note", "config.note2", "", 2, true, "configuration2",
			"settings2", "set2", "options2", "config2"),
	ANNOUNCE(32, "ann", "ann.description", "ann.usage", "ann.aliases", "nextPageSpec", 1, false, "announce",
			"ann", "broadcast", "broad", "shout"),
	ANNOUNCE1(32, "ann", "ann.description", "ann.usage", "ann.aliases", "nextPageSpec", 1, false, "yell",
			"ann1", "broadcast1", "broad1", "shout1"),
	ANNOUNCE1A(32, "ann", "ann.description", "ann.usage", "ann.aliases", "nextPageSpec", 1, false, "yell1",
			"announce1"),
	ANNOUNCE2(33, "ann", "ann.permission", "ann.note", "", "", 2, true, "ann2", "broadcast2", "broad2",
			"shout2", "yell2"),
	ANNOUNCE2A(33, "ann", "ann.permission", "ann.note", "", "", 2, true, "announce2");
